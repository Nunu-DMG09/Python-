...
class MessageHandler:
    def __init__(self, csv_file='BOT/responses.csv'):
        ...
        self.recommendation_model = RecommendationModel('DATA/ventas.csv', 'DATA/productos.csv')
        self.ventas = pd.read_csv('DATA/ventas.csv')
